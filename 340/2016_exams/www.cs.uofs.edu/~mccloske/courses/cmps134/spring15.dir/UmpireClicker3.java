...
public class UmpireClicker3 {
   ...
   */
   ...
   // Each observer simply retrieves the "counter value" of the
   // appropriate WrapAroundCounter object using that object's
   // cntrVal() method, and then returns that retrieved value.

   public int getBallCount() { return ballCntr.cntrVal(); }
   
   public int getStrikeCount() { return strikeCntr.cntrVal(); }
   
   public int getOutCount() { return outCntr.cntrVal(); }
   
   public int getInningCount() { return inningCntr.cntrVal(); }
